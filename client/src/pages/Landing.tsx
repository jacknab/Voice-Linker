...
export default function Landing() {
  ...
  return (
    <div data-landing style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "#0d0d0d", color: "#fff", minHeight: "100vh" }}>
      ...
      {/* ── HERO ── */}
      <section id="hero" className="relative overflow-hidden border-0 outline-none" style={{ backgroundColor: "#0d0d0d" }}>
        {/* Background image — full image visible, anchored right */}
        <img
          src={heroImg}
          alt={heroAlt}
          style={{ display: "block", width: "100%", height: "auto", objectFit: "contain", filter: "saturate(0.9) brightness(0.95)", border: "none", outline: "none" }}
        />
        ...
        {/* Content */}
        <div className={`absolute inset-0 z-10 w-full flex items-start px-4 md:px-16 pt-8 md:pt-14 pb-10 justify-start`}>
