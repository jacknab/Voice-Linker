...
import { Phone, Mic, MessageCircle, Users, Star, ChevronRight, CheckCircle, Headphones, Heart, Shield, Clock, Zap, Play } from "lucide-react";
...
const STEPS = [
  {
    ...
    title: "Call In",
    description: "Dial our local number and get instant access. No apps, no downloads, no profile photos — just your voice.",
    color: "#A855F7",
  },
  {
    ...
    >
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            Skip the apps. Call in, record your voice, and connect with real people in your area — live, 
            right now. It's dating the way it was always meant to be.
          </motion.p>
          ...
          >
            ...
            >
              ...
              Call Free — 1-800-555-0100
            </a>

            <button
              onClick={() => scrollTo("#how-it-works")}
              style={{
                background: "rgba(241, 240, 255, 0.07)",
                border: "1px solid rgba(241, 240, 255, 0.15)",
          ...
          <motion.p
            ...
            style={{ fontSize: "0.8rem", color: "rgba(241, 240, 255, 0.4)", textTransform: "none" }}
          >
          ...
          >
            <span style={{ fontSize: "0.875rem", color: "rgba(241,240,255,0.6)", whiteSpace: "nowrap", textTransform: "none", fontWeight: 400 }}>
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { label: "Live on the Line", value: stats?.activeCalls ?? 0, suffix: "" },
              { label: "Registered Members", value: stats?.users ?? 0, suffix: "" },
              { label: "Voice Profiles", value: stats?.profiles ?? 0, suffix: "" },
              { label: "Messages Sent", value: stats?.messages ?? 0, suffix: "" },
            ].map((stat, i) => (
      ...
      <section id="how-it-works" style={{ padding: "6rem 0" }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <p style={{ fontSize: "0.8rem", color: "#A78BFA", textTransform: "uppercase", letterSpacing: "0.15em", fontWeight: 600, marginBottom: "0.75rem" }}>
              Simple by Design
            </p>
            <h2
              style={{
            ...
            {STEPS.map((step, i) => (
              <motion.div
                ...
                style={{
                  ...
                  border: `1px solid rgba(${step.color === "#A855F7" ? "168,85,247" : step.color === "#EC4899" ? "236,72,153" : "139,92,246"}, 0.2)`,
              ...
              >
                ...
                <p style={{ color: "rgba(241,240,255,0.6)", lineHeight: 1.7, fontSize: "0.95rem", textTransform: "none", fontWeight: 400 }}>
                  {step.description}
                </p>
              </motion.div>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p style={{ fontSize: "0.8rem", color: "#F472B6", textTransform: "uppercase", letterSpacing: "0.15em", fontWeight: 600, marginBottom: "0.75rem" }}>
                For Women
              </p>
              <h2
                style={{
              ...
              >
                Always free.{" "}
                <span style={{ background: "linear-gradient(90deg, #F472B6, #A78BFA)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                  Always in control.
                </span>
              </h2>
              <p style={{ color: "rgba(241,240,255,0.65)", lineHeight: 1.8, fontSize: "1rem", marginBottom: "2rem", textTransform: "none", fontWeight: 400 }}>
                TalkSpark is completely free for women. Browse voice profiles at your own pace, 
                send voice messages to anyone who catches your ear, and go live only when you're ready. 
              ...
              <a
                ...
                data-testid="her-call-free"
              >
                <Phone className="w-4 h-4" /> Try It Free
              </a>
            </motion.div>
            ...
            >
              ...
              <blockquote style={{ margin: 0 }}>
                <p style={{ fontSize: "1.15rem", lineHeight: 1.75, color: "rgba(241,240,255,0.85)", fontStyle: "italic", marginBottom: "1.5rem", textTransform: "none", fontWeight: 400 }}>
                  "I was done with dating apps. The voice thing changed everything for me. 
                  You hear someone laugh and you just know."
                </p>
                <footer>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <blockquote style={{ margin: 0 }}>
                <p style={{ fontSize: "1.15rem", lineHeight: 1.75, color: "rgba(241,240,255,0.85)", fontStyle: "italic", marginBottom: "1.5rem", textTransform: "none", fontWeight: 400 }}>
                  "I've tried every dating app. Nothing moves as fast as this. 
                  I was talking to someone within five minutes of my first call."
                </p>
                <footer>
            ...
            >
              ...
              <p style={{ color: "rgba(241,240,255,0.65)", lineHeight: 1.8, fontSize: "1rem", marginBottom: "2rem", textTransform: "none", fontWeight: 400 }}>
                Get a free trial the moment you call. No credit card, no forms, no profile to fill out. 
                Just record your greeting, start browsing, and find someone you actually want to talk to.
              </p>
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 2rem", display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((feature, i) => (
              ...
              >
                ...
                <p style={{ fontSize: "0.875rem", color: "rgba(241,240,255,0.55)", lineHeight: 1.65, textTransform: "none", fontWeight: 400 }}>
                  {feature.desc}
                </p>
              </motion.div>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            {PRICING.map((plan, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                style={{
                  background: plan.popular ? "linear-gradient(145deg, rgba(139,92,246,0.15), rgba(236,72,153,0.1))" : "rgba(255,255,255,0.03)",
                  border: plan.popular ? "1px solid rgba(139,92,246,0.5)" : "1px solid rgba(255,255,255,0.08)",
                  borderRadius: "1.25rem",
                  padding: "2rem",
                  position: "relative",
                  display: "flex",
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "0.25rem", marginBottom: "0.25rem" }}>
                  <span
                    style={{
                      fontSize: "2.5rem",
                      fontWeight: 800,
                      background: `linear-gradient(90deg, ${plan.color}, #F472B6)`,
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      fontFamily: "system-ui, sans-serif",
                    }}
                ...
                <a
                  ...
                  style={{
                    ...
                    justifyContent: "center",
                    gap: "0.5rem",
                    background: plan.popular ? "linear-gradient(135deg, #8B5CF6, #EC4899)" : "rgba(255,255,255,0.07)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                ...
                <p style={{ color: "rgba(241,240,255,0.8)", lineHeight: 1.75, fontSize: "0.95rem", fontStyle: "italic", marginBottom: "1.25rem", textTransform: "none", fontWeight: 400 }}>
                  "{t.text}"
                </p>
                <div>
      ...
      <section style={{ padding: "7rem 0" }}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            >
              <Phone className="w-5 h-5" /> Call 1-800-555-0100 Free
            </a>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p style={{ fontSize: "0.75rem", color: "rgba(241,240,255,0.25)", textTransform: "none", fontWeight: 400, textAlign: "center" }}>
              © 2026 TalkSpark. All rights reserved.<br />
              All members 18+ only.
            </p>
          </div>
        </div>
