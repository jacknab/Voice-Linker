...
export const callers = pgTable("callers", {
  ...
  currentIvrState: text("current_ivr_state"),
  currentIvrPath: text("current_ivr_path"),
  currentIvrUpdatedAt: timestamp("current_ivr_updated_at"),
...
export const membershipSettings = pgTable("membership_settings", {
  ...
  plan1Minutes: integer("plan1_minutes").notNull().default(1440),
  plan1PriceCents: integer("plan1_price_cents").notNull().default(399),
  plan2Name: text("plan2_name").notNull().default("Standard"),
  plan2Minutes: integer("plan2_minutes").notNull().default(0),
  plan2PriceCents: integer("plan2_price_cents").notNull().default(0),
  plan3Name: text("plan3_name").notNull().default("Basic"),
  plan3Minutes: integer("plan3_minutes").notNull().default(0),
  plan3PriceCents: integer("plan3_price_cents").notNull().default(0),
