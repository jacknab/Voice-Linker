...
const PROMPT_TEXTS: Record<string, string> = {
  ...
  "main_menu.mp3":                "Main menu. To enter the male box press 1. To add time or purchase a membership press 2. For mailboxes and personal ads press 3. For information on membership prices press 4. For your voicemail press 6. To manage your membership press 8. Press 0 for time remaining, or 9 to repeat these choices.",
  "mw_main_menu.mp3":             "Main menu. If you're ready to join the action press 1. To buy membership time press 2. For the men seeking men line press 5. To manage your membership press 8. Press 0 for time remaining, or 9 to repeat these choices.",
  ...
  "cancelled.mp3":                "Cancelled.",
  "package_load_error.mp3":       "We're having trouble loading package information. To return to the main menu press 9. To cancel press pound.",
  "purchase_pre_menu.mp3":        "If you have a promotional code press 1. Package options are read from the current membership settings. To repeat these choices press 9. To cancel press pound.",
  "promo_code_prompt.mp3":        "Enter your promotional code followed by the pound key. To cancel, press pound now.",
  "cs_menu_intro.mp3":            "Customer service.",
  "cs_menu_options.mp3":          "Press 1 for your full account details. Press 2 to add time to your account. Press 3 for billing information. Press 4 to leave a message for our billing team. Press pound to return to the main menu.",
  "cs_billing_title.mp3":         "Billing information.",
  "cs_billing_static.mp3":        "Time is deducted from your membership while you are connected to the system. You can add more time at any time by pressing 2 from the main menu. If you were recently charged and your time has not been applied, please leave a message for our billing team and we will investigate promptly.",
  "cs_billing_options.mp3":       "Press 2 to add time now. Press 4 to leave a message for the billing team. Press 9 to return to customer service. Press pound for the main menu.",
  "cs_account_title.mp3":         "Account details.",
  "cs_account_label_status.mp3":  "Status:",
  "cs_account_label_membership.mp3": "Membership type:",
  "cs_account_label_time.mp3":    "Time remaining:",
  "cs_account_greeting_yes.mp3":  "You have a greeting recorded.",
  "cs_account_greeting_no.mp3":   "You do not have a greeting recorded yet. You must record a greeting before other callers can hear you.",
  "cs_account_options.mp3":       "Press 2 to add more time. Press 9 to return to customer service. Press pound for the main menu.",
  "cs_account_error.mp3":         "We were unable to retrieve your account information at this time. Press 9 to return to customer service. Press pound for the main menu.",
  "cs_leave_message_prompt.mp3":  "Please describe your billing question or issue after the tone. Press any key when you are done.",
  ...
  "new_caller_close_to_you.mp3":  "Caller close to you.",
