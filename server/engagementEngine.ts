...
export const PROMPT_LIBRARY: EngagementPrompt[] = [
  ...
  { id: "petty_09", category: "picky", tone: "comedic",
    trigger: { requiredMoods: ["petty"], maxMessagesSent: 0, minAttentionDrain: 7 },
    lineText: "You have ghosted more guys tonight than most apps see in a week.",
    cooldownSeconds: 240 },
  ...
  { id: "petty_13", category: "picky", tone: "teasing",
    trigger: { requiredMoods: ["petty"], maxMessagesSent: 0, minAttentionDrain: 7 },
    lineText: "I genuinely admire the commitment to not connecting with anyone tonight. Truly.",
    cooldownSeconds: 260 },
  ...
  { id: "petty_15", category: "picky", tone: "teasing",
    trigger: { requiredMoods: ["petty"], maxMessagesSent: 0, minAttentionDrain: 5 },
    lineText: "Still shopping? You are very selective tonight. I mean that as a compliment. Mostly.",
    cooldownSeconds: 220 },
  ...
  { id: "petty_dominant_01", category: "dominant", tone: "commanding",
    ...
    lineText: "Enough. You have skipped enough guys tonight. The very next one — give him a real chance.",
    cooldownSeconds: 300 },
  ...
  { id: "activated_08", category: "reward", tone: "playful",
    trigger: { requiredMoods: ["activated"], minMessagesSent: 2, minAttentionDrain: 3 },
    lineText: "You are doing better than half the guys on this line tonight. And I mean that.",
    cooldownSeconds: 300 },
  ...
  { id: "activated_11", category: "reward", tone: "playful",
    ...
    lineText: "Four messages? You are breaking records tonight. Keep going.",
    cooldownSeconds: 380 },
  ...
  { id: "activated_13", category: "flirty", tone: "teasing",
    ...
    lineText: "You are clearly feeling it tonight. One more message and you are officially on a streak.",
    followUpAction: "suggest_send_message", cooldownSeconds: 240 },
  ...
  { id: "chaos_10", category: "dominant", tone: "commanding",
    ...
    lineText: "Game played. Long session. Zero messages. Something has to give tonight. Send someone a message right now.",
    followUpAction: "suggest_send_message", cooldownSeconds: 420 },
  ...
  { id: "high_01", category: "dominant", tone: "commanding",
    ...
    lineText: "I am going to need you to make a move tonight. Any move. The browsing phase is over.",
    followUpAction: "suggest_send_message", cooldownSeconds: 360 },
  ...
  { id: "medium_01", category: "picky", tone: "teasing",
    ...
    lineText: "Seven skips and counting. Your standards are doing the heavy lifting tonight.",
    cooldownSeconds: 200 },
  ...
  { id: "medium_08", category: "idle", tone: "teasing",
    ...
    lineText: "You are in a listening mood tonight. Nothing wrong with that. But listening only gets you so far.",
    followUpAction: "suggest_send_message", cooldownSeconds: 200 },
  ...
  { id: "cycle_browse_01", category: "idle", tone: "playful",
    ...
    lineText: "Welcome in. Take a look around. No pressure tonight — just listen and see what catches your ear.",
    cooldownSeconds: 180 },
  { id: "cycle_browse_02", category: "idle", tone: "seductive",
    trigger: { requiredCycleStages: ["browse"], maxSessionSeconds: 120, maxSkips: 5 },
    lineText: "Tonight is full of interesting voices. You picked a good time to browse.",
    cooldownSeconds: 160 },
  ...
  { id: "cycle_tension_01", category: "reengagement", tone: "seductive",
    ...
    lineText: "Something is building tonight. I can feel it. I think you can too.",
    cooldownSeconds: 200 },
  ...
  { id: "cycle_tension_03", category: "flirty", tone: "seductive",
    ...
    lineText: "I have been watching. You are close to something good tonight. Do not give up now.",
    cooldownSeconds: 210 },
  { id: "cycle_tension_04", category: "reengagement", tone: "teasing",
    trigger: { requiredCycleStages: ["tension"], minSkips: 3, minAttentionDrain: 3 },
    lineText: "The interesting part of tonight is right around the corner. Just keep going.",
    cooldownSeconds: 200 },
  ...
  { id: "cycle_tension_06", category: "reengagement", tone: "playful",
    ...
    lineText: "We are building toward something tonight. I just need you to stay with me a little longer.",
    cooldownSeconds: 200 },
  ...
  { id: "cycle_engage_02", category: "reward", tone: "seductive",
    trigger: { requiredCycleStages: ["engage"], minEngagementStreak: 3 },
    lineText: "You switched gears tonight and it is showing. Keep that going.",
    cooldownSeconds: 240 },
  ...
  { id: "cycle_reward_roger_remembers", category: "reward", tone: "seductive",
    ...
    lineText: "I have to be honest with you — you came back tonight and I noticed. That means something around here.",
  ...
  { id: "cycle_reward_bonus_game", category: "game_invite", tone: "playful",
    ...
    lineText: "You have earned a bonus round of the Busted game tonight. No charge. That one is on me. Press 8 if you catch the AI.",
    followUpAction: "start_game", cooldownSeconds: 99999 },
  { id: "cycle_reward_special_greeting", category: "reward", tone: "seductive",
    trigger: { requiredCycleStages: ["reward"], minEngagementStreak: 5 },
    lineText: "I do not say this to everyone — but you are genuinely one of my favorite callers tonight. Keep doing exactly what you are doing.",
    cooldownSeconds: 99999 },
  { id: "cycle_reward_acknowledgment", category: "reward", tone: "comedic",
    trigger: { requiredCycleStages: ["reward"], minEngagementStreak: 6 },
    lineText: "You have been putting in work tonight and it has not gone unnoticed. Consider this your official acknowledgment from Roger.",
    cooldownSeconds: 99999 },
