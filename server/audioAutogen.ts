...
export const MM_PROMPTS: Prompt[] = [
  ...
  { filename: "record_message.mp3",         text: "Please record your message. Record after the tone. Hit any key when you're done." },
  { filename: "record_reply.mp3",           text: "Please record your reply. Record after the tone. Hit any key when you're done." },
  { filename: "message_review_header.mp3",  text: "Here's how it sounds. Press 1 at any time to send." },
  { filename: "message_review_options.mp3", text: "Re-record your message, press 2. To repeat your message, press 3. To cancel your message, press pound." },
  ...
  { filename: "mailbox_ad_recorded_pending.mp3",  text: "Thanks for recording your ad. Your ad is now live and other callers can find you right away. You can browse other ads or visit the male box to check out who's on the line right now." },
